...
const columns: ColumnDef<any>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <Badge variant={status === "paid" ? "outline" : status === "pending" ? "secondary" : "destructive"}>
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem>Edit Student Information</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      )
    },
